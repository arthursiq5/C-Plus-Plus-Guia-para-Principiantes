...
### [O GCC e suas nuances](https://www.geeksforgeeks.org/compiling-with-g-plus-plus/)
...
Para criar o primeiro programa, primeiro importe da [biblioteca padrão](https://pt.wikipedia.org/wiki/Biblioteca_padr%C3%A3o_do_C%2B%2B) as [interfaces de manipulação de entrada e saída](https://docs.microsoft.com/pt-br/cpp/standard-library/iostream?view=vs-2019). Para isso, insira a seguinte linha antes de inserir seu código:
